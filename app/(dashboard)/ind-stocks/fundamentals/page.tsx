    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="content-panel p-4 space-y-4 min-w-0 overflow-hidden">
          <h3 className="text-sm font-semibold">IND Fundamental Analysis</h3>
        ...
        <div className="md:col-span-3 space-y-4">
          ...
          {rows.length > 0 && (
            <>
              <div className="content-panel p-4"><FundamentalCharts data={rows} /></div>
              <div className="content-panel p-4"><FundamentalTable data={rows} /></div>
            </>
          )}
        </div>
      </div>
