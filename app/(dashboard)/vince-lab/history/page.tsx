...
import { useVinceHistory } from "@/hooks/use-vince";
import { TrendingUp } from "lucide-react";

export default function VinceHistoryPage() {
  const historyQ = useVinceHistory();

  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        <TrendingUp className="h-5 w-5 text-emerald-500" />
        <h2 className="text-lg font-semibold">Vince Risk — Run History</h2>
      </div>
