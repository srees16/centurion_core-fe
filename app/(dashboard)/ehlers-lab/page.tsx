  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        ...
        <a href="/ehlers-lab/history" className="ml-auto flex items-center gap-1.5 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
