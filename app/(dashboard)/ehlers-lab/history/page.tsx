...
import { useEhlersHistory } from "@/hooks/use-ehlers";
import { Activity } from "lucide-react";

export default function EhlersHistoryPage() {
  const historyQ = useEhlersHistory();

  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        <Activity className="h-5 w-5 text-cyan-500" />
        <h2 className="text-lg font-semibold">Ehlers DSP — Run History</h2>
      </div>
